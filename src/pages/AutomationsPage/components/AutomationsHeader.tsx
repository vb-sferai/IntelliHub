...
import { HaikuLogo } from './HaikuLogo';
...
/**
 * AutomationsHeader — custom scroll-aware header
 *
 * In Hero: transparent bg, white text/logo
 * After scroll: white bg, dark text, shadow
 * Mobile: burger menu
 */
            ...
            >
                <div className="mx-auto flex h-20 max-w-[1280px] items-center justify-between px-6 md:px-12 lg:px-16 xl:px-0">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <HaikuLogo
                            textColor={
                                isScrolled || isMenuOpen ? 'black' : 'white'
                            }

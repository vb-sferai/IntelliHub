    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <div className="relative min-h-screen w-full flex items-center justify-center -mt-14 sm:-mt-20">
                <Dithering1 colorBack="#00000000" colorFront="#0D5C3D" speed={0.11} shape="warp" type="4x4" size={3.3} scale={1.66} frame={72643.8470000289} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: '#0A1F15' }} />
                <div className="relative z-10 flex flex-col w-full text-center items-center gap-3 xs:gap-4 xl:gap-10 px-4 sm:px-12 lg:px-16 xl:px-0 max-w-[1408px] text-white py-20">
                    ...
                    <Button color="white" width="190px" onClick={scrollToCourses}>Записаться</Button>
                </div>
            </div>
            <div className="flex flex-col px-4 sm:px-12 lg:px-16 xl:px-0 xl:w-312 xl:mx-auto pt-12 md:pt-16 lg:pt-20 xl:pt-24 pb-16 md:pb-20 lg:pb-24 xl:pb-32">
                        ...
                        {SPEAKERS.map((speaker, index) => (
                            <div key={index} className="flex-1 w-full max-w-[343px] lg:max-w-none mx-auto bg-[#F7F7F5] p-6 lg:p-8 flex flex-col gap-6 items-center text-center">
                                <div className="relative shrink-0">
                                    <Dithering1 className="w-[180px] h-[180px] lg:w-[160px] lg:h-[160px] rounded-full" colorBack="#00000000" colorFront="#0D5C3D" speed={0.11} shape="warp" type="4x4" size={3.3} scale={1.66} frame={72643.8470000289} style={{ backgroundColor: '#0A1F15' }} />
                                    <img
                        ...
                        {COURSES.map((course, index) => (
                            <div key={index} className="flex-1 relative w-full max-w-[343px] lg:max-w-none mx-auto min-h-[420px] lg:min-h-[420px] p-6 lg:p-8 flex flex-col overflow-hidden">
                                ...
                                <div className="relative z-10 flex flex-col gap-3">
                                    ...
                                    <p className="text-sm lg:text-base font-bold leading-[1.3] text-white/70">
                                        {course.subtitle}
                                    </p>
                                </div>
                                <div className="relative z-10 flex flex-col gap-4 mt-auto mb-8">
                                    {course.items.map((item, itemIndex) => (
                                        <p key={itemIndex} className="text-sm lg:text-base font-medium leading-[1.5] text-white/70 whitespace-pre-line">
                                            — {item}
                                        </p>
                                    ))}
                                </div>
                                <a
                                    ...
                                    className="relative z-10 w-full max-w-[200px] mx-auto py-3 px-6 bg-[#d9d9d9] hover:bg-white rounded-full text-center text-base font-bold text-black/70 transition-colors"
                                >
                                    {course.buttonText}
                                </a>
                            </div>
                ...
                <div className="flex relative w-full mt-20 xl:mt-37 lg:items-center">
                    <Dithering1 colorBack="#00000000" colorFront="#0D5C3D" speed={0.11} shape="warp" type="4x4" size={3.3} scale={1.66} frame={72643.8470000289} style={{ width: '100%', backgroundColor: '#0A1F15' }} className="h-96 sm:h-92 lg:h-64" />
                    <div
                        ...
                        <a href="https://t.me/kgurbanov" target="_blank" rel="noopener noreferrer">

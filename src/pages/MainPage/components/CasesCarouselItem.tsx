...
export const CasesCarouselItem = ({ client, request, results, stack }: CasesCarouselItemProps) => {
    ...
    return (
        <div className={`flex flex-col md:flex-row gap-8 md:gap-12 w-[374px] sm:w-[calc(100vw-96px)] lg:w-[calc(100vw-128px)] xl:w-[calc(100vw-224px)] 2xl:w-[calc(100vw-320px)] md:h-173 bg-[#F7F7F5] pl-6 pt-6 pr-5 pb-11 flex-shrink-0`}>

...
export const EventsCarouselItem = ({ date, title, text, speaker, speakerRole, speakerPhotoUrl }: EventsCarouselItemProps) => {
    return (
        <div className="flex flex-col justify-between bg-[#F7F7F5] w-90 h-77 p-8">
            ...
            <div className="flex flex-row gap-3">
                <img className="w-10 h-10 rounded-full border border-black" src={speakerPhotoUrl} alt={speaker} />

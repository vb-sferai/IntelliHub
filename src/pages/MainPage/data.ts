...
export const CASES = [
    ...
    },
    {
        client: 'Яндекс',
        logoUrl: YandexLogo,
        request: 'Офлайн-интенсив для команды маркетинга Яндекс.Алиса по эффективному использованию AI-инструментов. Кастомная программа для создателей одного из лучших AI-продуктов страны.',
        results: [
            {
                title: '20+',

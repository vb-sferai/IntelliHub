// Testimonial data
const SUCCESS_TESTIMONIAL = {
  quote:
    '«Я за неделю сделал работу, которую программист выполняет 4-5 месяцев»',
  description:
    'Наш выпускник Александр самостоятельно собрал полноценное веб-приложение, которое помогает оформлять заявления на банкротство',
};
